...
def initialize_aws_setup(
    role: str, session_name: str, topic_name: str, topic_arn: str, queue_name: str
):
    """
    Initialize the AWS setup by creating an SNS topic and an SQS queue
    ...
    topic_arn = (
        ...
        else create_topic(sns_client=sns_client, topic_name=topic_name)
    )
