...
def receive_message_from_queue(postgres_client, table_name, sqs_client, queue_url, columns):
    """
    ...
    try:
        ...
        for message in messages:
            ...
            postgres_client.insert_data(table_name=table_name, data=postgres_client.data)
